...
class MemberController extends Controller {
    public function register(Request $request) {
        ...
        if ($phone != '') {
            ...
            $m3_email->to = $email;
            $m3_email->cc = 'zhouxiaodong902@163.com';
            $m3_email->subject = '凯恩书店验证';
            $m3_email->content = '请于24小时之内点击该链接完成验证，http://localhost/shop/service/validate_email'
                                . '?member_id=' . $member->id
                                . '&code=' . $uuid;
            ...
            $tempEmail->code = $uuid;
            $tempEmail->deadline =date('Y-m-d H:i:s', time() + 60 * 60);
            $tempEmail->save();
