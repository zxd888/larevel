...
@section('content')
<link rel="stylesheet" href="{{asset('public/css/swipe.css')}}"/>
            ...
            <div class="swipe" id="mySwipe">
                <div class="swipe-wrap">
                    @foreach($pdt_images as $pdt_image)
                        <div>
                            <a href="javascript:;"><img class="img-responsive" src="{{url('public/')}}/{{$pdt_image->image_path}}" /></a>
                        </div>
                    @endforeach
                </div>
            </div>
...
@section('my-js')
<script type="text/javascript" src="{{asset('public/js/swipe.min.js')}}"></script>
